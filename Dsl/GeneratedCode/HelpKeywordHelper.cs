...
namespace UPM_IPS.PLFLARCCAYRClassWeb
{
	...
	/// </remarks>
	public partial class PLFLARCCAYRClassWebHelpKeywordHelper : PLFLARCCAYRClassWebHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebHelpKeywordHelper.
		/// </summary>
		protected PLFLARCCAYRClassWebHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PLFLARCCAYRClassWebHelpKeywordHelper.
		/// </summary>
		public static PLFLARCCAYRClassWebHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PLFLARCCAYRClassWebHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebHelpKeywordHelperBase.
		/// </summary>
		protected PLFLARCCAYRClassWebHelpKeywordHelperBase()
			: base() { }
