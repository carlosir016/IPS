...
namespace UPM_IPS.PLFLARCCAYRClassWeb
{
	...
	/// </remarks>
	public partial class PLFLARCCAYRClassWebToolboxHelper : PLFLARCCAYRClassWebToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebToolboxHelper.
		/// </summary>
		public PLFLARCCAYRClassWebToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class PLFLARCCAYRClassWebToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify PLFLARCCAYRClassWeb toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "PLFLARCCAYRClassWeb.1.0";
		...
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebToolboxHelperBase.
		/// </summary>
		protected PLFLARCCAYRClassWebToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebDomainModel.SingletonResourceManager.GetString("PLFLARCCAYRClassWebToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "UPM_IPS.PLFLARCCAYRClassWeb.ClaseToolToolboxItem":
					// Add ClaseTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.PLFLARCCAYRClassWeb.ClaseToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("PLFLARCCAYRClassWebToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.PLFLARCCAYRClassWeb.ClasePadre.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.PLFLARCCAYRClassWeb.AtributoToolToolboxItem":
					// Add AtributoTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.PLFLARCCAYRClassWeb.AtributoToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("AtributoToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("AtributoToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("PLFLARCCAYRClassWebToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"AtributoTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("AtributoToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::UPM_IPS.PLFLARCCAYRClassWeb.Atributo.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.PLFLARCCAYRClassWeb.OperacionToolToolboxItem":
					// Add OperacionTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.PLFLARCCAYRClassWeb.OperacionToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						3, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("OperacionToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("OperacionToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("PLFLARCCAYRClassWebToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"OperacionTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("OperacionToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::UPM_IPS.PLFLARCCAYRClassWeb.Operacion.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.PLFLARCCAYRClassWeb.ParametroToolToolboxItem":
					// Add ParametroTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.PLFLARCCAYRClassWeb.ParametroToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						4, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("ParametroToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("ParametroToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("PLFLARCCAYRClassWebToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ParametroTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("ParametroToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::UPM_IPS.PLFLARCCAYRClassWeb.Parametros.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebDomainModel));
