...
namespace UPM_IPS.PLFLARCCAYRClassWeb
{
	...
	/// </summary>
	internal partial class PLFLARCCAYRClassWebCommandSet : PLFLARCCAYRClassWebCommandSetBase
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebCommandSet.
		/// </summary>
		public PLFLARCCAYRClassWebCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PLFLARCCAYRClassWebCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebCommandSetBase.
		/// </summary>
		protected PLFLARCCAYRClassWebCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPLFLARCCAYRClassWebExplorerCommand,
				typeof(PLFLARCCAYRClassWebEditorFactory).GUID);
		...
		{
			PLFLARCCAYRClassWebExplorerToolWindow explorer = this.PLFLARCCAYRClassWebExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PLFLARCCAYRClassWebDocData CurrentPLFLARCCAYRClassWebDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PLFLARCCAYRClassWebDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PLFLARCCAYRClassWebDocView CurrentPLFLARCCAYRClassWebDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PLFLARCCAYRClassWebDocView;
			}
		}
		...
		/// </summary>
		protected PLFLARCCAYRClassWebExplorerToolWindow PLFLARCCAYRClassWebExplorerToolWindow
		{
			get
			{
				PLFLARCCAYRClassWebExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PLFLARCCAYRClassWebExplorerToolWindow), true) as PLFLARCCAYRClassWebExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PLFLARCCAYRClassWebExplorerToolWindow explorerWindow = this.PLFLARCCAYRClassWebExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PLFLARCCAYRClassWebClipboardCommandSet : PLFLARCCAYRClassWebClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebClipboardCommandSet.
		/// </summary>
		public PLFLARCCAYRClassWebClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PLFLARCCAYRClassWebClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebClipboardCommandSetBase.
		/// </summary>
		protected PLFLARCCAYRClassWebClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
