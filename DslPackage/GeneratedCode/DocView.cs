...
namespace UPM_IPS.PLFLARCCAYRClassWeb
{
	...
	/// </summary>
	internal partial class PLFLARCCAYRClassWebDocView : PLFLARCCAYRClassWebDocViewBase
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebDocView.
		/// </summary>
		public PLFLARCCAYRClassWebDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PLFLARCCAYRClassWebDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new PLFLARCCAYRClassWebDocView.
		/// </summary>
		protected PLFLARCCAYRClassWebDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			PLFLARCCAYRClassWebDocDataBase docData = this.DocData as PLFLARCCAYRClassWebDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for PLFLARCCAYRClassWebDocViewBase should be an PLFLARCCAYRClassWebDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.PLFLARCCAYRClassWebDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.PLFLARCCAYRClassWeb.PLFLARCCAYRClassWebHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
